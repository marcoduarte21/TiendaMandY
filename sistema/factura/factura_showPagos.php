		...
		<tr>
			...
			<td class="info_factura">
				<div class="round">
					...
					<p>No. Factura: <strong><?php echo $credito['id']; ?></strong></p>
					<p>Fecha: <?php echo $credito['fecha']; ?></p>
					<p>Hora: <?php echo $credito['hora']; ?></p>
					<p>Vendedor: <?php echo $credito['vendedor']; ?></p>
				</div>
			</td>
		</tr>
	</table>
