...
if( isset($_REQUEST['busqueda']) && $_REQUEST['busqueda'] == ''){
    header("location: ventasCredito.php");
}
...
<body>
    ...
    <a href="nueva_venta.php" class="btn_new"><i class="fa-solid fa-plus"></i> <i class="fa-solid fa-file-invoice-dollar"></i> Añadir nueva venta</a>
