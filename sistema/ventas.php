...
<head>
	...
	<title>Lista de ventas contado</title>
</head>
<body>
	<?php include "includes/header.php"?>
	<section id="container">
		
    <h1>Lista de ventas contado</h1>
...
$sql_register = mysqli_query($conection, "SELECT COUNT(*) as total_registro FROM factura WHERE estatus != 10 AND id_formapago = 1");
...
WHERE f.estatus != 10 AND id_formapago = 1
